...
const About = () => {
  return (
    <section id="about" className="about">
      ...
      <p>
        I thrive in dynamic environments and am always eager to learn new skills. I am well-versed in <strong>cloud technologies</strong> such as <strong>AWS</strong> and <strong>Docker</strong>, which I leverage for efficient deployment and scaling of applications. My approach to software development emphasizes clean code, user-centered design, and continuous improvement through feedback and testing.
      </p>
      <p>
