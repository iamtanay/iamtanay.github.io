  ...
  const education = [
    {
      ...
      description: [
        ...
        'Focus on deep learning, neural networks, and AI system design.',
        'Research in cutting-edge AI applications and algorithms.',
      ],
    ...
    <section id="education" className="py-20 relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <motion.div
            variants={itemVariants}
            className="bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm rounded-2xl p-8 shadow-xl border border-gray-200/50 dark:border-gray-700/50 relative overflow-hidden"
          >
            {/* Background gradient */}
            <div className="absolute inset-0 bg-gradient-to-br from-green-500 to-teal-500 opacity-5 dark:opacity-10"></div>
            ...
            <div className="relative z-10">
              ...
              <div className="flex items-center mb-6">
                ...
                <h3 className="text-2xl font-bold bg-gradient-to-r from-green-500 to-teal-500 bg-clip-text text-transparent">Certifications</h3>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-4">
                {certifications.map((cert, index) => (
                  <motion.div
                    ...
                    className="flex items-center p-4 bg-gradient-to-r from-green-500/10 to-teal-500/10 rounded-xl border border-green-500/20 dark:border-green-400/30 hover:border-green-400/40 dark:hover:border-green-300/50 transition-all duration-300"
                  >
